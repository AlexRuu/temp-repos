...
const register = async (req, res) => {
  ...
  // send verification tokn only while testing in postman
...
const verifyEmail = async (req, res) => {
  ...
  const user = await User.findOne({ email });
  if (!user) {
    throw new CustomError.UnauthorizedError(`${email} does not exist`);
  }
...
const forgotPassword = async (req, res) => {
  ...
  res
    ...
    .json({ msg: "Check email for reset password link" });
};
